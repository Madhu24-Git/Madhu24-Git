...
### A passionate Business Analyst from Chennai
...
* 	Data Collection & Validation             * Requirement gathering & documentation
*   Business Reporting & Analytics           * MS Excel (VLOOKUP, HLOOKUP)
*   Power BI (Dashboard & KPI)               * Power point Presentation
*   Python & SQL                             * SOP documentation
*   Root cause analysis & Chane requests     * JIRA & Confluence 
*   Stakeholder Communication                * Cross-functional Collaboration
*   Process Documentation                    * UAT & Functional testing
